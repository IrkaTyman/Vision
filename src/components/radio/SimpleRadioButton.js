...
export {Text, View, TouchableOpacity, TouchableWithoutFeedback, LayoutAnimation, Platform, UIManager} from 'react-native'
...
export default class RadioForm extends React.Component {
  ...
  clearSelection(){ this.setState({is_active_index:-1})}
